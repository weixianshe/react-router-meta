...
function tr() {
  if (it)
    return se;
  it = 1;
  var e = ft, r = Symbol.for("react.element"), a = Symbol.for("react.fragment"), n = Object.prototype.hasOwnProperty, o = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, s = { key: !0, ref: !0, __self: !0, __source: !0 };
  function l(u, h, m) {
    var d, E = {}, x = null, y = null;
    m !== void 0 && (x = "" + m), h.key !== void 0 && (x = "" + h.key), h.ref !== void 0 && (y = h.ref);
    for (d in h)
      n.call(h, d) && !s.hasOwnProperty(d) && (E[d] = h[d]);
    if (u && u.defaultProps)
...
function rr() {
  return st || (st = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function _(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === n || t === s || f || t === o || t === m || t === d || g || t === y || Z || B || U || typeof t == "object" && t !== null && (t.$$typeof === x || t.$$typeof === E || t.$$typeof === l || t.$$typeof === u || t.$$typeof === h || // This needs to include all possible module reference object
...
function or(e) {
  ...
  var h = I.Pop, m = s(), d = m[0], E = m[1], x = be(), y = be();
...
function vr(e, r) {
  ...
  return a.some(ut) && (n += pr), r && (n += fr), a.filter((o) => !ut(o)).reduce((o, s) => o + (ur.test(s) ? cr : s === "" ? hr : dr), n);
}
function mr(e, r) {
...
function Ir(e, r) {
  ...
  let {
    matches: a
  } = Y(ee), n = a[a.length - 1], o = n ? n.params : {}, s = n ? n.pathname : "/", l = n ? n.pathnameBase : "/", u = n && n.route;
  if (process.env.NODE_ENV !== "production") {
    let w = u && u.path || "";
    sr(s, !u || w.endsWith("*"), "You rendered descendant <Routes> (or called `useRoutes()`) at " + ('"' + s + '" (under <Route path="' + w + '">) but the ') + `parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.
...
function Yr(e) {
  ...
  let s = o.current, [l, u] = dt({
    action: s.action,
    location: s.location
  });
  return pt(() => s.listen(u), [s]), /* @__PURE__ */ z(_t, {
    basename: r,
    children: a,
    location: l.location,
...
function Hr({
  ...
  if (n && typeof n == "function")
    ...
    const o = X(), s = Q(
      () => gt(r, o),
      [r, o]
    ), l = Q(() => s == null ? void 0 : s.some((u) => {
      const h = u.route;
      return h.meta ? h.meta.auth : !1;
    }), [s]);
    if (l && !a)
      return /* @__PURE__ */ Le(ct, { to: "/", state: { form: o.pathname }, replace: !0 });
    if (!l && a && o.pathname === "/login")
      return /* @__PURE__ */ Le(ct, { to: "/dashboard", replace: !0 });
  }
...
function St(e, r) {
  return xt(e).filter((o) => {
    var s, l;
    return o.children && (o.children = St(o.children, r)), (l = (s = o.meta) == null ? void 0 : s.roles) == null ? void 0 : l.includes(r);
  });
}
export {
  Yr as BrowserRouter,
